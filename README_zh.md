...
- **智能对话**: 直接询问 Node-RED 开发问题
- **工具调用**: AI 自动调用 MCP 工具辅助开发
- **历史记录**: 对话记录自动保存，支持多轮交互
- **节点切换**: 支持在不同配置的 LLM 节点间自由切换

### 节点配置界面

简单配置即可开始使用：

![Dev Copilot 节点配置](images/c7aa1d15e320912cc77066da9f1250137670aa6c43d50444e576aec4b5eec900.png)

**配置要点:**

- **AI 服务**: 支持 OpenAI、Google Gemini、DeepSeek 等
- **参数调优**: 可调节 LLM 参数
- **MCP 集成**: 默认选用 node-red-mcp
